...
_OUTLOOK_TEMPLATES: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "render": lambda v: (
            ...
            f"<h1 style='margin:0;font-size:20px'>📊 {_esc(v.get('project_name', 'Project'))} — Status Update</h1>"
            "</div>"
    ...
    },
    {
        ...
        "render": lambda v: (
            ...
            f"<h1 style='margin:0;font-size:20px'>⚠️ {_esc(v.get('alert_title', 'Alert'))}</h1>"
        ...
        "render": lambda v: _json.dumps(
            {
                ...
                "body": [
                    ...
                    },
                    {
                        "type": "FactSet",
                        "facts": [
                            {"title": "Owner", "value": v.get("owner", "—")},
                            {"title": "Status", "value": v.get("status", "—")},
                        ],
                    },
                ],
            },
